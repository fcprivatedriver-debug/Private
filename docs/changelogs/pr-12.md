...
Lançamento da aplicação **Nina — Assistente financeira pessoal**: plataforma completa em português para controlar receitas, despesas, orçamentos e objetivos da família, com design premium e arquitetura modular.
...
Rebrand completo: a Nina é uma assistente financeira pessoal baseada em IA. Experiência conversacional no centro.
