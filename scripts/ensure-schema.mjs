...
const DEFAULT_CLASSES = [
  {
    ...
    namePt: "Economy",
    nameEn: "Economy",
    descriptionPt: "Transfer económico e fiável até 4 passageiros",
    descriptionEn: "Reliable economy transfer up to 4 passengers",
    minPassengers: 1,
    maxPassengers: 4,
    maxLuggage: 2,
    iconKey: "economy",
  ...
  },
  {
    ...
    namePt: "Comfort",
    nameEn: "Comfort",
    descriptionPt: "Veículos confortáveis até 4 passageiros",
    descriptionEn: "Comfortable vehicles up to 4 passengers",
    minPassengers: 1,
    maxPassengers: 4,
    maxLuggage: 3,
    iconKey: "comfort",
  ...
  },
  {
    ...
    namePt: "Van",
    nameEn: "Van",
    descriptionPt: "Vans para famílias e grupos até 8 passageiros",
    descriptionEn: "Vans for families and groups up to 8 passengers",
    minPassengers: 1,
    maxPassengers: 8,
    maxLuggage: 8,
    iconKey: "van",
...
const RETIRED_CODES = ["PREMIUM", "SEDAN", "EXECUTIVE", "LUXURY", "MINIBUS", "BUS"];
