...
const CATALOG: CatalogEntry[] = [
  ...
  {
    id: "cont-ovos-12",
    name: "Ovos classe M 12 un. Continente",
    brand: "Continente",
    weight: "12 un",
    categorySlug: "lacticinios",
    priceCents: 239,
    ...
    storeName: "Continente",
    storeId: "continente",
    productUrl: "https://www.continente.pt/produto/ovos-12",
    keywords: ["ovos", "ovo"],
  },
  {
    id: "pd-pao-forma",
    name: "Pão de forma Pingo Doce 700 g",
    brand: "Pingo Doce",
    weight: "700 g",
    categorySlug: "padaria",
    priceCents: 119,
    ...
    storeName: "Pingo Doce",
    storeId: "pingo_doce",
    productUrl: "https://www.pingodoce.pt/produto/pao-forma",
    keywords: ["pao", "pão", "forma"],
  },
  {
    id: "cont-arroz-carolino-1kg",
    name: "Arroz Carolino Continente 1 kg",
    brand: "Continente",
    weight: "1 kg",
    categorySlug: "mercearia",
    priceCents: 119,
    ...
    storeName: "Continente",
    storeId: "continente",
    productUrl: "https://www.continente.pt/produto/arroz-carolino-1kg",
    keywords: ["arroz", "carolino"],
  },
  {
    id: "pd-arroz-carolino-1kg",
    name: "Arroz Carolino Pingo Doce 1 kg",
    brand: "Pingo Doce",
    weight: "1 kg",
    categorySlug: "mercearia",
    priceCents: 109,
    ...
    storeName: "Pingo Doce",
    storeId: "pingo_doce",
    productUrl: "https://www.pingodoce.pt/produto/arroz-carolino-1kg",
    keywords: ["arroz", "carolino"],
  },
  {
    id: "cont-azeite-750",
    name: "Azeite Virgem Extra Continente 750 ml",
    brand: "Continente",
    weight: "750 ml",
    categorySlug: "mercearia",
    priceCents: 449,
    ...
    storeName: "Continente",
    storeId: "continente",
    productUrl: "https://www.continente.pt/produto/azeite-750",
    keywords: ["azeite", "virgem"],
  },
  {
    id: "pd-azeite-750",
    name: "Azeite Virgem Extra Pingo Doce 750 ml",
    brand: "Pingo Doce",
    weight: "750 ml",
    categorySlug: "mercearia",
    priceCents: 429,
    ...
    storeName: "Pingo Doce",
    storeId: "pingo_doce",
    productUrl: "https://www.pingodoce.pt/produto/azeite-750",
    keywords: ["azeite", "virgem"],
  },
  {
    id: "cont-agua-6x15",
    name: "Água Continente 6×1,5 L",
    brand: "Continente",
    weight: "6x1.5L",
    ...
    storeName: "Continente",
    storeId: "continente",
    productUrl: "https://www.continente.pt/produto/agua-6x15",
    keywords: ["agua", "água", "garrafa"],
  },
  {
    id: "pd-agua-6x15",
    name: "Água Pingo Doce 6×1,5 L",
    brand: "Pingo Doce",
    weight: "6x1.5L",
    categorySlug: "bebidas",
    priceCents: 189,
    ...
    storeName: "Pingo Doce",
    storeId: "pingo_doce",
    productUrl: "https://www.pingodoce.pt/produto/agua-6x15",
    keywords: ["agua", "água", "garrafa"],
  },
  {
    id: "cont-manteiga-mimosa-250",
    name: "Manteiga Mimosa com Sal 250 g",
    brand: "Mimosa",
    weight: "250 g",
    categorySlug: "lacticinios",
    priceCents: 229,
    ...
    storeName: "Continente",
    storeId: "continente",
    productUrl: "https://www.continente.pt/produto/manteiga-mimosa-250g",
    keywords: ["manteiga", "mimosa", "sal"],
  },
];
